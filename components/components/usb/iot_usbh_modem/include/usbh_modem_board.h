...
#ifndef usbh_modem_board_c_
#define usbh_modem_board_c_ extern
#else
#define usbh_modem_board_c_
#endif
...
usbh_modem_board_c_ char modem_imei[66];
usbh_modem_board_c_ char modem_sn[66];
usbh_modem_board_c_ char modem_iccid[66];
usbh_modem_board_c_ char modem_imsi[66];
usbh_modem_board_c_ int  modem_rssi;
    ...
    /**
     * @brief Force power up modem through power pin
     *
     * @return esp_err_t
     */
    esp_err_t modem_board_force_powerup(void);
